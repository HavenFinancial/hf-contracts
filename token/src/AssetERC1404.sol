...
import "../ERC1404/ManagedWhitelist.sol";
import "../ERC1404/MessagedERC1404.sol";

contract AssetERC1404 is MessagedERC1404 {
    ...
    function detectTransferRestriction(address from, address to, uint value) public view returns (uint8 restrictionCode)
    {
        if (!sendAllowed[from]) {
