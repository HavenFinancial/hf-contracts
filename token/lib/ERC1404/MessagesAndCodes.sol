...
library MessagesAndCodes {
    ...
    function messageIsEmpty (string _message) internal pure returns (bool isEmpty)
    {
    ...
    function addMessage (Data storage self, uint8 _code, string _message) public returns (uint8 code)
    {
    ...
    function autoAddMessage (Data storage self, string _message) public returns (uint8 code)
    {
        require(!messageIsEmpty(_message), EMPTY_MESSAGE_ERROR);
    ...
    function removeMessage (Data storage self, uint8 _code) public returns (uint8 code)
    {
    ...
    function updateMessage (Data storage self, uint8 _code, string _message) public returns (uint8 code)
    {
        require(!messageIsEmpty(_message), EMPTY_MESSAGE_ERROR);
        require(messageExists(self, _code), CODE_UNASSIGNED_ERROR);
